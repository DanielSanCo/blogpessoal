...
@Injectable() //Significa que poderei usar isso em outros lugares
export class PostagemService {
    constructor (
        @InjectRepository(Postagem) //Para passar com intregidade os dados para outro locais
    ...
    async create(postagem: Postagem): Promise<Postagem> { //Metodo POST
